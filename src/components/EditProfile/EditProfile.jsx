                        ...
                        <ul>
                            {suggesFiltered.map(suggestion => (
                                <li key={suggestion._id}>
                                    <p>hola</p>
                                    <span onClick={() => handleSuggestionClick(suggestion)} className='tag_alt span'> {suggestion.name}</span>
                        ...
                        {suggestions.map((allergen, index) => (
                            <li key={index}>
                                <span className='tag_alt span mg-b-10'>
                                    {allergen.name}
                                    <button type="button" onClick={() => handleRemoveAllergen(allergen._id)} className='no_bg'><span className="material-symbols-rounded icon_btt link">close</span></button>
                                </span>
                            </li>
                        ))}
